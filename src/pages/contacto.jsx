...
export default function contacto() {
  return (
    <div className='w-full h-auto flex lg:flex-row flex-col py-[2rem] bg-center bg-no-repeat bg-cover' style={{ backgroundImage: `url(${background})` }}>
      <div className='flex lg:flex-row flex-col w-full gap-5 lg:gap-0'>
        <div className='lg:w-[50%] w-full  flex flex-col justify-center items-start gap-4 px-[1rem] lg:px-[4rem]'>
          <p className='lg:text-[3.5rem] text-[2.5rem] font-semibold text-white montserrat'>Contactanos</p>
        ...
        <div className='flex gap-3 items-center'>
          ...
          <div className='flex flex-col text-white montserrat'>
            <p className='font-semibold lg:text-[1.3rem] '>Dirección:</p>
            <p className='lg:text-[1rem] text-[0.8rem]'>Av. Córdoba 4318, CABA C1414 </p>
          </div>
        </div>
        {/* TELEFONO */}
        <div className='flex gap-3 items-center'>
        <svg class="w-[4rem] h-[4rem] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <div className='flex flex-col text-white montserrat'>
            <p className='font-semibold lg:text-[1.3rem]'>Whatsapp:</p>
            <p className='lg:text-[1rem] text-[0.8rem]'>+54 11 2400 1758</p>
            <p className='lg:text-[1rem] text-[0.8rem]'>+54 11 7162 0611</p>
          </div>
        </div>
        {/* CORREO */}
        <div className='flex gap-3 items-center '>
          ...
          <div className='flex flex-col text-white'>
            <p className='font-semibold lg:text-[1.3rem] montserrat'>Correo electrónico:</p>
            <p className='montserrat lg:text-[1rem] text-[0.8rem]'>aberturas.luxor@gmail.com</p>
          </div>
        </div>
        </div>
